...
if __name__ == '__main__':
    ...
    parser.add_argument('--iterations', default=3, type=int, help="Number of iterations to run the entire experiment for. Default 1")
    parser.add_argument('--test_size', default=20, type=int, help="Split fraction for training and testing set. Defualt 20.")
